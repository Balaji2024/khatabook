...
{
   printf("\n Please enter only 12 digits account number... \n");
   goto acc;
}
}
    ...
    void login()
{
   ...
   printf("Enter your password:");
    ...
    if( strcmp ( username,"khatabook" ) == 0 && strcmp ( password,"password" ) == 0 )
    {
        printf("\n\nPassword Match!");
    ...
    {
        printf("\n\nInvalid password/Username!!\a\a\a");
        login_try:
